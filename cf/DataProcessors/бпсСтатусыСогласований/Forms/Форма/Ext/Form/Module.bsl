...
Процедура УстановитьВидимостьДоступность()	
	...
	Если ЗначениеЗаполнено(Объект.ОбъектБД) Тогда
		Заголовок = StrTemplate(NStr("ru = 'Статус согласования [%1]'", Объект.ОбъектБД));
		АвтоЗаголовок = Ложь;		
	Иначе
...
Процедура КомандаОтменитьСогласование(Команда)
	...
	ПоказатьВопрос(ОповещениеОЗакрытии,
					NStr("ru = 'Отменить согласование?'"),
...
Процедура КомандаУстановитьСтатус(Команда)
	...
	ПоказатьВводЗначения(Оповещение, пСтатус, NStr("ru = 'Укажите статус объекта'"), ОписаниеТипов);
КонецПроцедуры
