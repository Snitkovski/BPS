...
Функция ПолучитьТекущегоПользователя()
	...
	Если Результат.Пустой() Тогда
		...
		Исключение
			...
			//	|" + ОписаниеОшибки());
			ТекстПредупреждения = StrTemplate(nstr("ru = 'Пользователь: %1 не был найден в справочнике пользователей. Возникла ошибка при добавлении пользователя в справочник.
