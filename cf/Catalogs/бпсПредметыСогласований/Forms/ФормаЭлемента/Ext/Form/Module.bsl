...
Процедура УстановитьВидимостьДоступность() Экспорт
	...
	Если пИспользуетсяВСогласованиях Тогда
		...
		Если ВключеноРедактирование Тогда
			...
			ТолькоПросмотр = Ложь;						
			ТекстСообщения = NStr("ru = 'Редактирование разрешено.'");
			Сообщение = Новый СообщениеПользователю;
			Сообщение.Текст = ТекстСообщения;
			Сообщение.Сообщить();			
		Иначе			
			ТекстСообщения = NStr("ru = 'ВНИМАНИЕ! Предмет согласования уже используется - редактирование запрещено.
                                  |Если все равно хотите его изменить, тогда Включите редактирование!'");
			Сообщение = Новый СообщениеПользователю;
			Сообщение.Текст = ТекстСообщения;
