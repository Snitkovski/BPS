...
Процедура ПроверитьИспользуетсяЛиВПредметахСогласования(Отказ)
	...
	Если НЕ РезультатЗапроса.Пустой() Тогда
		Отказ = Истина;
		Сообщить(NStr("ru = 'Ошибка! Нельзя изменять тип объекта, т.к. он уже используется в предметах согласования'"));
	Конецесли;
КонецПроцедуры 
...
Процедура ПроверитьУникальностьТипаОбъекта(Отказ)
	...
	Если НЕ РезультатЗапроса.Пустой() Тогда
		Отказ = Истина;
		Сообщить(NStr("ru = 'Ошибка! Уже есть такой тип объекта, два одинаковых быть не может'"));
	Конецесли;
КонецПроцедуры 
